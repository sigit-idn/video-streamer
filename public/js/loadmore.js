    ...
    jQuery(document).ready(function () {
        function loadmore_n_infinityscroll() {
            ...
            function loadMore(jQuerywrapper) {
                ...
                button.on("click", button, function () {
                    var data = {
                        ...
                        view: jQuery("body").hasClass("product-list-view")
                            ? "list"
                            : "grid",
                        paged: CurrentPage,
                    };
                    jQuery.ajax({
                        ...
                        success: function success(data) {
                            ...
                            jQuery(
                                ".gen-movie-contain .movie-actions--link_add-to-playlist .dropdown-toggle"
                            ).html('<i class="fa fa-plus"></i>');
                            jQuery(
                                ".gen-movie-contain .tv-show-actions--link_add-to-playlist .dropdown-toggle"
                            ).html('<i class="fa fa-plus"></i>');
                            jQuery(
                                ".gen-movie-contain .video-actions--link_add-to-playlist .dropdown-toggle"
                            ).html('<i class="fa fa-plus"></i>');
                        },
                    });
                    return false;
            ...
            function isScrollable(jQuerywrapper) {
                var ajaxVisible =
                        jQuerywrapper.offset().top +
                        jQuerywrapper.outerHeight(true),
                    ajaxScrollTop =
